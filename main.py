...
for city in cities:
    ...
    city_formatted = city+'/' #*****change this city to what you want!!!!*****

    #just grabbing the first 20 pages
    #feel free to make this prettier
    url1 = 'https://www.zillow.com/homes/for_sale/'+city_formatted
    url2 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/2_p/'
    url3 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/3_p/'
    url4 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/4_p/'
    url5 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/5_p/'
    url6 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/6_p/'
    url7 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/7_p/'
    url8 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/8_p/'
    url9 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/9_p/'
    url10 = 'https://www.zillow.com/homes/for_sale/'+city_formatted+'/10_p/'
    ...
    # print(df[['id','address','beds','baths','area','price','zestimate','best_deal']].head(len(df)))

    for index, row in df.iterrows():
        db.add_zillow(df[['id','address','beds','baths','area','price','zestimate','best_deal']], city)
